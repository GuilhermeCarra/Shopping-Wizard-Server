...
?>
    ...
    <body class="bg-light">
      ...
      <div class="container d-flex flex-row mw-100" id="container">
        ...
        <div  id="form-login" class="d-none mx-auto w-25 p-3 mt-5 rounded" style="background-color:white;">
          <p class="font-weight-bold mt-3">Login Admin</p> <br>
          <div class="form-group" id="email-div">
            <label for="email">Email</label>
            <input type="email" class="form-control border border-dark" id="email-admin">
          </div>
          <div class="form-group" id="password-div">
            <label for="password">Password</label>
            <input type="password" class="form-control border border-dark" id="password-admin">
          </div>
          <button type="submit" id="submit-admin" class="btn btn-dark w-100 mt-1 mb-3">Submit</button>
        </div>
        <!--Div Navbar Vertical-->
        <div class="d-none" id="navbar-admin">
